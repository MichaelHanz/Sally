...
export default function App() {
        ...
        bill_of_materials: [
          {
            ...
            specification:
              "EPYC 7763 (128 Cores total), 1TB DDR4 RAM, 2x 1.92TB NVMe SSD",
            qty: 4,
            unit_price: 12450.0,
            total: 49800.0,
          },
          {
            ...
            specification:
              "100TB Usable capacity, PCIe Gen5 backplane, Dual Active-Active Controllers",
            qty: 2,
            unit_price: 28900.0,
            total: 57800.0,
          },
          {
            ...
            specification:
              "32-port QSFP28, Layer 3 Routing, ONIE support, Redundant Hot-Swap PSUs",
            qty: 2,
            unit_price: 8200.0,
            total: 16400.05,
          },
          {
            ...
            specification:
              "Precision layout planning, deployment path calculation, system performance tuning",
            qty: 40,
            unit_price: 250.0,
            total: 10000.0,
          },
  ...
  const handleProposalCreated = (newProposal: Proposal) => {
    const existsIdx = proposals.findIndex(
    ...
    <div className="min-h-screen bg-[#F8FAFC] text-slate-800 font-sans flex flex-col selection:bg-indigo-100 pb-12">
      ...
      <footer className="mt-auto border-t border-slate-200 py-6 text-center text-xs text-slate-500">
        <div className="mx-auto max-w-7xl px-4 flex flex-col sm:flex-row items-center justify-between gap-2 select-none">
          <span>
            © 2026 Sally Autonomous B2B Systems Consultation. Autonomous
            Precision.
          </span>
          <div className="flex space-x-4">
            <span className="text-slate-400">
              Prototype for a Hackathon Problem
            </span>
            <span className="hover:text-slate-900 cursor-pointer hidden sm:inline">
              Privacy and SLA Policy
            </span>
